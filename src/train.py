...
if __name__ == "__main__":
    ...
    # example script usage: python train.py --dataset_name swarm-2 --device 0 --epochs 200 --latent 64 --dropout 0.5 --lr 5e-3 --noise 0.4 --runs 20 --layer_type TransformerConv
