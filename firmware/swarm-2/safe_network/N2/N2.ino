...
float randsens[4] = {0.0,0.0,0.0,0.0};
char control[4] = {'0','0','0','0'};
float min[4] = {0.0,3.0,10.0,15.0};
float max[4] = {4.0,7.0,14.0,19.0};
char data[32];
byte receive;
int flag = -1;
